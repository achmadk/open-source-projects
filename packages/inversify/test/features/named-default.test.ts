...
describe("Named default", () => {
  ...
  it("Should be able to inject a default to avoid ambiguous binding exceptions", () => {
    ...
    expect(ninja.weapon.name).toEqual("Shuriken");
    expect(samurai.name).toEqual("Samurai");
    expect(samurai.weapon.name).toEqual("Katana");
  ...
  it("Should be able to select a default to avoid ambiguous binding exceptions", () => {
    ...
    expect(defaultWeapon.name).toEqual("Katana");
    expect(throwableWeapon.name).toEqual("Shuriken");
