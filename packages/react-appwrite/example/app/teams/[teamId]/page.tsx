...
import {
  useTeam,
  useTeamCreateMembership,
  useTeamMembers,
  useTeamRename,
} from "react-appwrite/teams";
  ...
  return (
    <div className="flex flex-col justify-center items-center flex-1 gap-2">
      ...
      <div className="flex items-center justify-center gap-4">
        <form
          className="bg-white text-black rounded-sm p-4 flex flex-col items-center justify-center gap-4"
          onSubmit={async (e) => {
            e.preventDefault();
        ...
        >
          ...
          <div className="flex items-center font-bold gap-2">
            {" "}
            requires SMTP enabled{" "}
            <a
              href="https://appwrite.io/docs/email-delivery"
              target="_blank"
              rel="noreferrer"
            >
              <FiLink />
